...
# ══════════════════════════════════════════════════════════════
# CALIBRATOR (FIXED: Uses LogisticRegression, compatible with Colab)
# ══════════════════════════════════════════════════════════════
        ...
        try:
            ...
            for i, out in enumerate(['HOME', 'DRAW', 'AWAY']):
                if out in self.models:
                    # استخراج الاحتمال المعدل باستخدام predict_proba للفئة الموجبة (1)
...
class Disp:
    ...
    def header():
        ...
        print(C.cyan(" ║") + C.dim("  Calibrator FIXED (LogisticRegression - Colab compatible)  ") + C.cyan("║"))
        print(C.cyan(" ╚══════════════════════════════════════════════════════════════╝"))
        print()
...
def run_streamlit():
    ...
    st.caption("Multi-League • Deep Stats CSV • Per-League ML Models • 68 Features • Backtest Fixed • Calibrator Fixed")
